    ...
    <form action="{{ url('products/update') }}" method="POST" class="flex flex-col justify-center items-center mx-20 mt-5 cursor-pointer">
        ...
        <div class="flex flex-col w-1/2 font-dmSans">
            ...
            <div class="flex flex-col mt-5">
                ...
                <input name="name" id="name" type="text" value="{{ $product['name'] }}" class="px-3 py-2 rounded border-gray-400 active:border-violet-700 focus:outline-none focus:ring focus:ring-violet-300 dark:bg-blueDark">
            </div>

            <div class="flex flex-col mt-5">
                <label for="description" class="mb-2 text-gray-800 font-medium dark:text-zinc-200">Descrição</label>
                <div class="relative">
                    <textarea name="description" id="description" class="block w-full rounded border border-gray-400 focus:outline-none focus:ring focus:ring-violet-300 resize-none dark:bg-blueDark">{{ $product['description'] }}</textarea>
            ...
            <div class="grid grid-flow-col gap-4 mt-5">
                <div class="flex flex-col">
                    ...
                    <div class="relative">
                        <input name="quantity" id="quantity" type="number" value="{{ $product['quantity'] }}" class="block w-full px-3 py-2 rounded border border-gray-400 focus:outline-none focus:ring focus:ring-violet-300 appearance-none dark:bg-blueDark">
                        <div class="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none">
                ...
                <div class="flex flex-col">
                    ...
                    <div class="relative">
                        <input name="price" id="price" type="number" value="{{ $product['price'] }}" class="block w-full px-3 py-2 rounded border-gray-400 focus:outline-none focus:ring focus:ring-violet-300 appearance-none custom-number-input dark:bg-blueDark">
                        <div class="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none">
            ...
            <div class="flex flex-col mt-5">
                ...
                <select name="type_id" id="type_id" class="select select-info w-full rounded dark:bg-blueDark border-gray-400">
