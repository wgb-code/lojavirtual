<x-app-layout>
    ...
    <div id="toast" class="toast toast-end fixed z-50">
        <div class="alert bg-green-600 text-white shadow-lg rounded-lg p-4 flex flex-col">
            <span>{{$message}}</span>
            <progress id="progressBar" class="progress progress-success w-56" value="0" max="100"></progress>
            <button id="closeToast" class="btn btn-sm btn-danger ml-2">Fechar</button>
        </div>
    </div>
    @endif
